...
def self.random_robot_maker
  names = ["Arelis", "Kisha","Jane", "Atiya", "Celeste", "Raissa", "Erik", "Mark", "Ramon"]
  ...
  def to_s
      "My name is #{name},  I am #{type}, I was created in #{@origin}"
  end
...
def add_wings_and_take_off
  puts "I am badass! I am #{name}, an awesome #{type}  with flying skills"
end
def add_laser_training
  if type == "Super Android"
    puts "I am #{name}, LASER MASTER!"
  else
    puts "I wish I had Lasers :("
